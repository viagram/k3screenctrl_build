...
PKG_SOURCE_VERSION:=15308f104b1746b4e6f2a6d2ea59723c6403c762
...
define Package/k3screenctrl
  SECTION:=utils
  CATEGORY:=Utilities
  DEPENDS:=@TARGET_bcm53xx_generic_DEVICE_phicomm_k3 +@KERNEL_DEVMEM +jq +coreutils +coreutils-od +bash +curl
